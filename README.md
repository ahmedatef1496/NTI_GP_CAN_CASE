...
- It utilizes FreeRTOS to start sending and receiving CAN frames on command.
- It also sends back the final output of the test to be evaluated from the laptop.
| [hex]()         |
