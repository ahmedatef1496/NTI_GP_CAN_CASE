...
|------|------------------|--------------|-------------------------------------------------------------------------------------------------------------------------------------|-----------------|
| 1    | [CAN Case]()     | STMF103C8T6  | - An ARM-based converter that reads the CAN configuration over a UART connection from the laptop- It utilizes FreeRTOS to start sending and receiving CAN frames on command- It also sends back the final output of the test to be evaluated from the laptop.| [hex]()         |
